<?php
include '../model/Sertifikat.php';
include '../config/auth.php';
include '../config/mahasiswa.php';

$db = new Sertifikat();
$Sertifikat = $db->getSertifikat($_GET['id']);
?>
